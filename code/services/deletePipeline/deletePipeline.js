...
// This doesn't delete the pipeline row but just updates it to be in an invalid state
// so that mlPipelineBuilder can delete it later. 

function deletePipeline(req, resp) {
